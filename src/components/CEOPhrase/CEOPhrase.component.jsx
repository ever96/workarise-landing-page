...
export const CEOPhrase = () => {
  return (
    <section className="w-full flex flex-col py-12 px-3 gap-3 lg:py-20 lg:w-[80%] lg:mx-auto">
      <img className='max-w-[80px] md:max-w-[120px] lg:max-w-[160px]' src={TraceOn} alt="Trace On Image" />
      ...
      <div className='flex justify-end pt-8'> 
        <img className='max-w-[80px] md:max-w-[120px] lg:max-w-[160px]' src={TraceOff} alt="Trace Off Icon" />
      </div>
    </section>
  )
}
