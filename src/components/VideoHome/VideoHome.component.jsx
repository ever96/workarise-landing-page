export const VideoHome = () => {
  return (
    <section className='w-full flex flex-col items-center gap-4 text-center py-10 px-4 lg:pt-32 lg:gap-8'>
      ...
      <iframe className="w-[400px] h-[30vh] md:w-[600px] md:h-[50vh] lg:w-[850px] lg:h-[70vh] xl:w-[1200px] xl:h-[90vh]" src="https://www.youtube.com/embed/ChaWggL8I40?vq=hd720&rel=0" title="Welcome to Workarise" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
    </section>
  )
}
